package kuvaev.mainapp.eatit.Component;
...
public class ElegantNumberButton extends RelativeLayout {
    ...
    private void initView() {
        inflate(context, R.layout.layout_elegant_number_button, this);
        final Resources res = getResources();
        final int defaultColor = res.getColor(R.color.colorPrimary);
        final int defaultTextColor = res.getColor(R.color.colorText);
        final Drawable defaultDrawable = res.getDrawable(R.drawable.elegant_number_button_background);
